...
delete from person where person_id=3;
insert into person(person_id, department, email, first_name, last_name, location, password, active, role_id) values(3, "testing", "test@g.com", "test", "test", "mumbai", "test", 1, 11);
